    ...
    if (userId) {
      try {
        historyId = await saveBlogHistory({
          ...
          tone: tone as 'friendly' | 'professional' | 'casual' | 'academic',
          targetAudience: targetAudience as 'general' | 'professional' | 'student' | 'expert',
          length: length as 'short' | 'medium' | 'long',
          blogStyle: blogStyle as 'basic' | 'seo' | 'marketing',
          additionalContent,
