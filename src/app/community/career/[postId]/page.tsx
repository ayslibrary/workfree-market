...
export default function CareerPostDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-blue-50/30 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 py-12">
        ...
        {/* 게시글 */}
        <FadeIn delay={0.1}>
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-blue-200 dark:border-blue-800 mb-6">
            {/* 제목 */}
        ...
        {/* 댓글 섹션 */}
        <FadeIn delay={0.2}>
          <div className="bg-white dark:bg-gray-900 rounded-2xl p-8 border-2 border-blue-200 dark:border-blue-800">
            ...
            {user ? (
              <form onSubmit={handleSubmitComment} className="mb-8">
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-700 rounded-xl focus:border-blue-500 focus:outline-none dark:bg-gray-800 dark:text-white resize-none"
                  rows={3}
