...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f0ff]">
      ...
      <div className="container mx-auto px-6 md:px-6 py-8 md:py-12 max-w-5xl pt-24 md:pt-20">
        {/* Hero */}
        <FadeIn>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 mb-8 md:mb-12">
            <div className="flex-1 text-center md:text-left">
              ...
              <h2 className="text-xl md:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 md:mb-6 leading-relaxed break-keep">
                &quot;퇴근을 앞당기는<br className="md:hidden" /> 가장 확실한 방법&quot;
              </h2>
              <div className="max-w-3xl mx-auto text-base md:text-base lg:text-base md:text-lg text-gray-700 break-keep space-y-2">
                <p className="font-semibold break-keep">당신의 시간을 되찾는 AI 자동화 스튜디오</p>
                <p className="break-keep">설치 없이 웹에서 바로 실행하는 실무 자동화 서비스</p>
              </div>
            </div>
            <div className="flex-shrink-0">
              <div className="relative w-32 h-32 md:w-48 md:h-48 bg-gradient-to-br from-purple-200 via-pink-200 to-rose-200 rounded-full flex items-center justify-center shadow-2xl">
        ...
        {/* 1. Pain Point */}
        <FadeIn delay={0.2}>
          <section className="bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-8 md:mb-12 mt-8 md:mt-12">
          <div className="flex flex-col md:flex-row items-start gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="flex-1">
              ...
              <p className="text-base md:text-base md:text-lg text-gray-700 break-keep mb-4 md:mb-6 break-keep">
                하루에도 수십 번 반복하는 루틴 업무들.<br />
                메일 확인, 엑셀 정리, 보고서 수정, PDF 변환…
              </p>
              <p className="text-base md:text-base md:text-lg text-gray-700 break-keep mb-4 md:mb-6 font-semibold">
                이런 상황, 익숙하지 않나요?
              </p>
              <ul className="space-y-3 mb-6 md:mb-8">
                <li className="flex items-start gap-3 text-gray-700 text-base md:text-base">
                  <span className="text-orange-500 text-xl flex-shrink-0">●</span>
                  <span className="break-keep">자동화 툴은 많지만 <strong>설치가 복잡하고 배우기 어렵다.</strong></span>
                </li>
                <li className="flex items-start gap-3 text-gray-700 text-base md:text-base">
                  <span className="text-orange-500 text-xl flex-shrink-0">●</span>
                  <span className="break-keep">유료 구독은 부담스럽고 <strong>사용 빈도가 낮아 아깝다.</strong></span>
                </li>
                <li className="flex items-start gap-3 text-gray-700 text-base md:text-base">
                  <span className="text-orange-500 text-xl flex-shrink-0">●</span>
                  <span className="break-keep">그래서 결국, <strong>사람이 다시 손으로 한다.</strong></span>
                </li>
              </ul>
            </div>
          ...
          <div className="bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-500 rounded-xl md:rounded-2xl p-5 md:p-6 text-white">
            <p className="text-lg md:text-xl font-bold mb-2 md:mb-3 break-keep">
        ...
        {/* 2. Solution */}
        <FadeIn delay={0.2}>
          <section className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-8 md:mb-12 border-2 border-purple-200">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6">
            💡 Solution — WorkFree는 이렇게 바꿉니다
          </h2>
          <p className="text-lg md:text-2xl font-bold text-purple-600 mb-6">
            &quot;설치 없이 웹에서 바로 실행. 크레딧으로 필요한 만큼만 사용.&quot;
          </p>
          <p className="text-base md:text-lg text-gray-700 break-keep mb-6">
            WorkFree는 <strong>직장인을 위한 AI 실무 자동화 스튜디오</strong>입니다.
          </p>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-purple-200">
              <div className="text-4xl mb-3">⚡</div>
              <p className="text-gray-700 font-bold mb-2">웹에서 즉시 실행</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep">설치·다운로드 불필요<br />브라우저에서 바로 사용</p>
            </div>
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-purple-200">
              <div className="text-4xl mb-3">💎</div>
              <p className="text-gray-700 font-bold mb-2">크레딧 시스템</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep">사용한 만큼만 차감<br />구독 부담 제로</p>
            </div>
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-purple-200">
              <div className="text-4xl mb-3">🤖</div>
              <p className="text-gray-700 font-bold mb-2">AI 기반 자동화</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep">복잡한 작업도<br />클릭 한 번으로 처리</p>
            </div>
          </div>
          <div className="bg-green-100 rounded-xl p-5 md:p-6 border-2 border-green-300">
        ...
        {/* 3. Beta Benefits */}
        <FadeIn delay={0.2}>
          <section className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-8 md:mb-12 border-2 border-indigo-200">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6">
            🎁 베타 프로그램 — 지금 시작하면
          </h2>
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-purple-200 hover:scale-105 transition-transform">
              <p className="font-bold text-gray-900 mb-2 text-xl">무료 크레딧 10개</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep mb-3">회원가입 즉시 지급</p>
              <p className="text-3xl font-bold text-purple-600">즉시 지급</p>
            </div>
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-green-200 hover:scale-105 transition-transform">
              <p className="font-bold text-gray-900 mb-2 text-xl">후기 작성 보상</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep mb-3">서비스 사용 후 리뷰</p>
              <p className="text-3xl font-bold text-green-600">+5 크레딧</p>
            </div>
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-pink-200 hover:scale-105 transition-transform">
              <p className="font-bold text-gray-900 mb-2 text-xl">SNS 공유 보상</p>
              <p className="text-sm md:text-sm text-gray-600 break-keep mb-3">친구에게 알리기</p>
              <p className="text-3xl font-bold text-pink-600">+10 크레딧</p>
            </div>
          </div>
          <div className="bg-gradient-to-r from-indigo-100 to-purple-100 rounded-xl p-6 md:p-8 border-2 border-indigo-300">
        ...
        {/* 4. How It Works */}
        <FadeIn delay={0.2}>
          <section className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-8 md:mb-12 border-2 border-blue-200">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-8">
            ⚙️ How It Works — 사용 방법
          </h2>
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-blue-200">
            ...
            <div className="text-center text-2xl text-gray-400">↓</div>
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-green-200">
          ...
          <div className="mt-8 bg-blue-100 rounded-xl p-5 md:p-6 border-2 border-blue-300">
            <p className="text-base md:text-lg text-gray-700 break-keep text-center">
        ...
        {/* 5. Pricing */}
        <FadeIn delay={0.2}>
          <section className="bg-white rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6">
            💰 Pricing — 크레딧 시스템
          </h2>
          <p className="text-base md:text-lg text-gray-700 break-keep mb-8">
            필요한 만큼만 사용하는 합리적인 가격
          </p>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 md:p-6 border-2 border-blue-200 hover:scale-105 transition-transform">
              <div className="text-4xl mb-3">🎁</div>
              ...
              <p className="text-sm md:text-sm text-gray-600 break-keep">1개월 유효</p>
            </div>
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl p-5 md:p-6 border-2 border-purple-200 hover:scale-105 transition-transform">
              <div className="text-4xl mb-3">💎</div>
              ...
              <p className="text-sm md:text-sm text-gray-600 break-keep">10개 단위 구매</p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-yellow-50 rounded-xl p-5 md:p-6 border-2 border-orange-200 hover:scale-105 transition-transform">
              <div className="text-4xl mb-3">🚀</div>
              ...
              <p className="text-sm md:text-sm text-gray-600 break-keep">200~1000 크레딧</p>
            </div>
          </div>
          <div className="mt-8 bg-green-100 rounded-xl p-5 md:p-6 border-2 border-green-300 text-center">
        ...
        {/* 6. Time Savings */}
        <FadeIn delay={0.2}>
          <section className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl md:rounded-3xl shadow-xl p-6 md:p-12 mb-8 md:mb-12 border-2 border-green-200">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="bg-white rounded-xl p-6 md:p-8 border-2 border-blue-200">
          ...
          <div className="bg-gradient-to-r from-green-100 to-emerald-100 rounded-xl p-6 md:p-8 border-2 border-green-300">
            <p className="text-xl md:text-2xl font-bold text-gray-900 text-center">
              월 10회 사용 시 ₩100,000+ 절약 효과<br />
              <span className="text-base md:text-lg text-gray-700 break-keep">(평균 5시간 절약)</span>
            </p>
          </div>
          </section>
        </FadeIn>
        ...
        <FadeIn delay={0.2}>
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-xl p-5 md:p-6 border-2 border-indigo-200">
        ...
        <FadeIn delay={0.2}>
          ...
          <ul className="space-y-4">
            <li className="flex items-start gap-3 text-base md:text-lg text-gray-700 break-keep">
              <span className="text-green-500 text-xl">✓</span>
          ...
          <div className="mt-8 bg-green-100 rounded-xl p-5 md:p-6 border-2 border-green-300">
